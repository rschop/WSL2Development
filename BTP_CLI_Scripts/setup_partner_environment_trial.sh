...
# declare delay=15
declare region="us10"
declare global_account_subdomain="27345fe2trial-ga"
declare directory_name="Project Risc"
declare directory_description="Richard's Project"
declare contact_person="raschop@outlook.com"
declare department="Risc"
declare subaccounts="dev test prod"
declare space="dev"
declare delay=15
...
main() {
  ...
  # login_btp "richard.schop@gmail.com" "Mercu01!1" "$region" "$global_account_subdomain"
